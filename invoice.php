                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr style="height: 72px; " class="bg-warning">
                                    ...
                                    <td class="fw-bold fs-6 text-end bg-warning pt-3"><?php echo $order_data["qty"]; ?></td>
                            ...
                            <tfoot>
                                ...
                                <tr>
                                    ...
                                    <td class="fs-5 text-end border-danger text-primary fw-bold">Rs. <?php echo $order_data["total"] + $product_data["delivery_fee_colombo"] - $discount ?> .00</td>
                                </tr>
