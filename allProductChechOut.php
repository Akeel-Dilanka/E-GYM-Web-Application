            ...
            ?>
                                                        ...
                                                        <div class="col-md-12 mt-3 mb-3">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-6 col-md-6 text-end">
                                                                    <span class="fw-bold fs-5 text-white-50"> Rs. <?php echo ($product_data["price"] * $cart_dt["qty"]) + $ship ?>.00</span>&nbsp;&nbsp;&nbsp;&nbsp;
                                                                </div>
                ...
                <div class="col-12 col-lg-4 offset-lg-4 border border-2 border-white" style="background-color: #17141d; border-radius: 30px; box-shadow: -1rem 0 3rem #000;">
                    <div class="row m-2">
                        ...
                        <div class="col-6">
                            <span class="fs-5 fw-bold text-white">Shipping&nbsp;
                                (RS.)</span>
                        </div>

                        <div class="col-6 text-end">
                            <input class="fs-5 fw-bold text-white border-0 text-end" style="background-color: #17141d; border: none;" type="text" value=" <?php echo $shipping ?>" disabled id="shipping">
                        </div>
                        ...
                        <div class="col-6 mt-2">
                            <span class="fs-3 fw-bold text-white">Total &nbsp;
                            (RS.)</span>
                        ...
                        <div class="col-6 mt-2 text-end">
                            ...
                            <input class="fs-4 fw-bold text-white border-0 text-end" style="background-color: #17141d; border: none;" type="text" value=" <?php echo $total + $shipping ?>" disabled id="payment">
                        </div>

                        <div class="col-12 mt-3 mb-3 d-grid">
                            <button class="btn btn-outline-danger fs-5 fw-bold rounded-pill" onclick="payNowAllProducts();">Pay Now</button>
                        </div>
