...
<head>
    ...
    <title>PowerGym | Manage Brand</title>
</head>
            ...
            <div class="col-12">
                <div class="row">
                    <div class="col-12 text-center fw-bold mb-3 mt-0 bg-dark">
                        <h2 class="fs-1 text-danger fw-bold">Manage All Brand</h2>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row g-1 text-center m-2">
                            ...
                            <hr class="border border-1 border-white" />
                                <nav class="nav flex-column">
                                    <a class="nav-link fw-bold fs-4 active" href="#">Manage Brand</a>
                ...
                <div class="row">
                    ...
                    <div class="col-12 mb-3 ">
                        <div class="row g-4">
                            ...
                            <div class="col-12 col-lg-3 border border-dark bg-warning" onclick="addNewBrand();" style="height: 60px;">
                                <div class="row">
                                    <div class="col-8 mt-2">
                                        <label class="form-label fw-bold fs-5 mt-1">Add New Brand</label>
                                    </div>
                            ...
                            ?>
                                ...
                                <div class="col-12 col-lg-3 border border-white bg-dark" style="height: 50px;">
                                    <div class="row">
                                        ...
                                        <div class="col-8 mt-2">
                                            <label class="form-label fw-bold fs-5 text-white"><?php echo $brand_data["name"]; ?></label>
                                        </div>
                                        <div class="col-4 border-start border-white text-center mt-2">
                                            <label for="form-label fs-3" onclick="deleteFromBrand(<?php echo $brand_data['id']; ?>);"><i class="bi bi-trash fs-4 text-danger"></i></label>
                                        </div>
                                    </div>
                                </div>
